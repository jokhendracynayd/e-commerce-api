...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
        ...
        PrismaService_1.prototype.clearDatabase = function () {
            return __awaiter(this, void 0, void 0, function () {
                var models;
                var _this = this;
                return __generator(this, function (_a) {
                    if (process.env.NODE_ENV !== 'production') {
                        ...
                        return [2 /*return*/, Promise.all(models.map(function (modelKey) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    return [2 /*return*/, this[modelKey].deleteMany()];
                                });
                            }); }))];
                    }
                    return [2 /*return*/];
