...
export class AttributeFilterDto {
  ...
  @ApiProperty({
    description: 'Unique key for the attribute (use in filter query)',
  })
  key: string;
  ...
  @ApiProperty({
    description: 'Priority order for display (lower appears first)',
  })
  priority: number;
...
export class FilterOptionsResponseDto {
  ...
  @ApiProperty({
    description: 'Available product tags',
    type: [FilterValueDto],
  })
  tags: FilterValueDto[];
...
export class FilterOptionsQueryDto {
  ...
  @ApiProperty({
    description: 'Category slug to get filters for',
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    description: 'Search term to get filters for',
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    description: 'Minimum price to consider for filter generation',
    required: false,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiProperty({
    description: 'Maximum price to consider for filter generation',
    required: false,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiProperty({
    description: 'Whether to include products from all subcategories',
    required: false,
    default: true,
  })
  @IsOptional()
